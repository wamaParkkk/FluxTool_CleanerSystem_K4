...
namespace FluxTool_CleanerSystem_K4
{
    public partial class PM1Form : UserControl
    {
        ...
        public void Display()
        {
            ...
            // Output display            
            if ((Global.digSet.curDigSet[(int)DigOutputList.CH1_Cylinder_Pwr_o] == "On") &&
                (Global.digSet.curDigSet[(int)DigOutputList.CH1_Cylinder_FwdBwd_o] == "Off"))
            {
                textBoxCylinderFwdBwd.Text = "Forward";
            }                
            else if ((Global.digSet.curDigSet[(int)DigOutputList.CH1_Cylinder_Pwr_o] == "On") &&
                     (Global.digSet.curDigSet[(int)DigOutputList.CH1_Cylinder_FwdBwd_o] == "On"))
            {
        ...
        private async void Digital_Click(object sender, EventArgs e)
        {
            ...
            */
            ...
            switch (strTmp)
            {
                ...
                case "3":
                    {
                        digitalDlg.Init2("Home", "Backward", "Forward", "CH1 Cylinder Fwd/Bwd");
                        if (digitalDlg.ShowDialog() == DialogResult.OK)
                        {
                            if (Global.GetDigValue((int)DigInputList.CH1_Door_Sensor_i) == "Off")
                            {
                            ...
                            else if (digitalDlg.m_strResult == "Backward")
                            {
                                ...
                                Global.SetDigValue((int)DigOutputList.CH1_Cylinder_FwdBwd_o, (uint)DigitalOffOn.On, ModuleName);
                                await Task.Delay(500);
